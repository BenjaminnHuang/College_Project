...
public class BrowserNavigation 
{
	...
	public static void main(String[] args) 
	{
		...
		final String TESTFILE_1 = "resources/links.txt";
		final String TESTFILE_2 = "resources/popEmptyStackOfLinks.txt";
		final String TESTFILE_3 = "resources/inputFile03.txt";

		final String FILENAME = TESTFILE_1;
