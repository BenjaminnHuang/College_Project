 ...
 *
 * @author Foothill College, Bita M [Hung-I, Huang]
 */
public class MyTunes 
{
	...
	public static void main(String[] args) 
	{
		...
		//Test Files that I added: resources/TestFileForIDs
		//						   resources/TestFileForGenres
		final String DATAFILE = "resources/music_genre_subset.json";	// Directory path for JSON file
		final String TESTFILE01 = "resources/TestFileForIDs";	// Example test file for hashing based on IDs
		final String TESTFILE02 = "resources/TestFileForGenres"; // Example test file for hashing based on genres names
